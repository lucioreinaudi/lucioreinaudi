...
-- Tiempo de generación: 09-11-2025 a las 00:33:00
...
--
-- Estructura de tabla para la tabla `resultados_sorteo`
--
...
CREATE TABLE `resultados_sorteo` (
  ...
  `idActividad` int(11) NOT NULL,
  `nombreActividad` varchar(45) NOT NULL,
  `tribu_equipo` varchar(45) NOT NULL,
...
--
-- Indices de la tabla `resultados_sorteo`
--
ALTER TABLE `resultados_sorteo`
  ADD PRIMARY KEY (`idresultado`),
  ADD KEY `idx_estudiante_fk` (`idEstudiante`),
  ADD KEY `idx_actividad_fk` (`idActividad`);
...
--
ALTER TABLE `actividad`
  MODIFY `idactividad` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1018;
...
--
ALTER TABLE `inscripciones`
  MODIFY `idinscripciones` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2403;

--
-- AUTO_INCREMENT de la tabla `resultados_sorteo`
--
ALTER TABLE `resultados_sorteo`
...
--
-- Filtros para la tabla `resultados_sorteo`
--
ALTER TABLE `resultados_sorteo`
  ADD CONSTRAINT `fk_actividad_resultado` FOREIGN KEY (`idActividad`) REFERENCES `actividad` (`idactividad`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_estudiante_resultado` FOREIGN KEY (`idEstudiante`) REFERENCES `estudiantes` (`idestudiantes`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
